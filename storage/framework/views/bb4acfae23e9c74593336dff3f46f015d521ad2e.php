<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3d597c;">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
            <?php if(auth()->guard()->check()): ?>
                <li class="nav-item <?php echo e($title == 'User' ? 'active' : ''); ?>">
                    <a class="nav-link" href="/user">Data Pegawai</a>
                </li>
                <li class="nav-item <?php echo e($title == 'Rekap' ? 'active' : ''); ?>">
  ...
  </nav><?php /**PATH E:\Semester 4\Pemograman Web Lanjut\Project Pemweb\Absensi-App\resources\views/components/navbar-admin.blade.php ENDPATH**/ ?>